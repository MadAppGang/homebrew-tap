class Mnemex < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.31.1/mnemex-darwin-arm64"
      sha256 "b2828637eccef0aa7ab14cd9c84c99cea8f69ca3c1012be2234ff606e68ef0b4"
    end
    on_intel do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.31.1/mnemex-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.31.1/mnemex-linux-arm64"
      sha256 "9d4dc010e27e4bc78102755e7a5c1e8a83e941d55891fec7be1f9a5157b32294"
    end
    on_intel do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.31.1/mnemex-linux-x64"
