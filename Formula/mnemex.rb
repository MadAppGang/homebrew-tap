class Mnemex < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.30.1/mnemex-darwin-arm64"
      sha256 "84cb18f301ff84589f67346cde92708e2b8a62005ffbb9a13e6a3bf6c0f29c88"
    end
    on_intel do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.30.1/mnemex-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.30.1/mnemex-linux-arm64"
      sha256 "48d9dc6f79a9842962e069a953939709266e7bd28bc982f35011ebdeb0088312"
    end
    on_intel do
      url "https://github.com/MadAppGang/mnemex/releases/download/v0.30.1/mnemex-linux-x64"
